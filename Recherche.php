...
<body style="background-image: url('images/spirale.gif');background-attachment:fixed">  
  ...
  ?>     
         <li class="dropdown-submenu">
                ...
                <a tabindex="-1" href="#collapseOne<?php echo $id_filiere; ?> "><?php  echo utf8_encode($val['nom']);?></a>
...
<?php
  ...
  { 
    ...
    ?>
                  ...
                  <li class="dropdown-submenu"><a tabindex="-1" href="#"><?php  echo utf8_encode($val_module['nom']);?></a>
        ...
        <form class="navbar-form navbar-left" role="button" action="Recherche.php" method="GET">
          ...
          <input type="text" class="form-control" name="search_field" placeholder="Mot cle !" >
...
<fieldset>
 ...
 if (isset($_GET['search_button'])) 
 {
        ...
        {
          echo utf8_encode("<i>il faut entrer un mot clé!</i>");
        }
        else{

          $data = $cours->chercher_cours_mc($search_field);
          if (empty($data)) {


            echo utf8_encode("<i>Aucun résultat  n'a été trouvé pour le mot clé « ".$search_field." » !</i><br/>");
          }
          else
          {
                 # code...
            ?><br><br><th>
                <?php  echo utf8_encode("<i>Le résultat de votre recherche pour le mot clé « ".$search_field." » est: </i><br/>");
                ?></th></br></br>

      <?php
                  foreach($data as $valeur) 
                  {
                     ?><img src="style/link.png"><?php echo "<p><a href='".$valeur['format_cours']."' target='_blank'>".utf8_encode($valeur['nom_cours'])."</p>";
                  } 
