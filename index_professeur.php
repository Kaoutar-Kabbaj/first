        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">  <div class="container">
            <div class="navbar-header">
              ...
              <li class="active"><a href="index_Utilisateur.php">Accueil</a></li>
                ...
                <li ><a href="presentation.php">Gérer les cours</a></li>
    ...
    <section id="aboutUs">
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
         ...
         <br>
         <br>
         <p>La plate-forme E-learning vous donne la possibilité de gérer les cours
         de vos étudiants,où que vous soyez.  </p>
         <p>En effet vous pourriez modifier, supprimer ainsi ajouter vos cours sous
          différents formats,en plus de cela vos cours seront organisés selon 
         une structure hiérarchique et dynamique!</p>
